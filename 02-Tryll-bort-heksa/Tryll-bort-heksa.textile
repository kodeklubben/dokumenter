...
table(oversikt).
|!(symbol). ../images/sjekkliste-symbol.png!|%(sjekkliste)Sjekkliste%| – |Følg instruksjonene på lista. Huk av etter hvert.|
|!(symbol). ../images/test-symbol.png!| %(test)Test%| – |Klikk på det grønne flagget for å teste koden.|
|!(symbol). ../images/lagre-symbol.png!| %(lagre)Lagre%| – |Husk å lagre koden når du har lagt til noe nytt.|

h2. Steg 1: Lag en flyvende heks

!(symbol). ../images/sjekkliste-symbol.png! %(sjekkliste)Sjekkliste%
...
!(symbol). ../images/lagre-symbol.png! %(lagre)Lagre prosjektet%
...
|^. 2. | Lag så følgende skript:!(skript). skript-3a.png!|^. !(sjekkrute). ../images/sjekkrute.png!|
