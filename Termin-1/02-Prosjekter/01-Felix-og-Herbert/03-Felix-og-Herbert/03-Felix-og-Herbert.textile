...
# Velg fanen 'Drakter' og slett den tredje drakten ved å trykke på X i hjørnet av drakten. !dog2-c.png!
# Velg fanen 'Skript' og lag dette skriptet:
!(skript)skript1.png!
...
!(skript)skript4.png!
# Velg Herbert og gå til fanen 'Drakter'.
...
# På fanen 'Skript' under kategorien 'Data', lag en ny variabel. La den gjelde for alle figurer og kall den poengsum.
