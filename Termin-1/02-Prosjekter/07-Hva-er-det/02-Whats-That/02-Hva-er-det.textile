...
# Klikk på %(klikk)Scene% og deretter på %(klikk)Bakgrunner%-fanen. %(klikk)Importer Innendørs/chalkboard%-bakgrunnen.
# *Importer en valgfri figur*.
# *Plasser den i midten av tavlen*, og endre størrelsen hvis den ikke passer.!(systemdetalj). endre-storrelse.png!
