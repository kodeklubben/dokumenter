...
Denne sesjonen er der barna møter kodeklubben for første gang. Derfor er det veldig viktig at du skaper et inkluderende og støttende miljø hvor barna føler seg velkomne. Ikke forhast deg og prøv ikke å bli oppgitt over mangel på fremdrift eller forståelse. Les dokumentet Creating a positive learning environment for mer veiledning.

h3. Steg

Gå gjennom ett og ett av disse stegen . Forsikre deg om at alle barna har utført ett steg før du fortsetter med det neste.
* Åpne Scratch
* Gi Figur1 navnet ‘Felix’

h3. Frittstående blokker

* Dobbeltklikk på blokken !bevegelse-ga-10-steg.png(Gå 10 steg)! i !kategori-bevegelse.png(Bevegelse)!-kategorien. Forklar at Felix har flyttet seg.
...
* Vis hvordan man åpner !kategori-lyd.png(Lyd)!-kategorien.
...
* Kommenter at vi har lyst til å få det til å se ut som om Felix går.
* Åpne !fane-drakter.png(drakter)!-fanen.
* Vis at Felix har to drakter.
* Åpne !fane-skript.png(skript)!-fanen
* Legg til !utseende-neste-drakt.png(neste drakt)! fra !kategori-utseende.png(utseende)!-kategorien inn i løkken.
* Dobbeltklikk på skriptet og se at Felix går til kanten av scenen.
Du har nå et skript som ser slik ut:

!skript1.png(Skript 1)!
